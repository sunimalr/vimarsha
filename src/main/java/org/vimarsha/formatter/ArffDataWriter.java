 ...
 * User: gayashan
 */
public class ArffDataWriter implements DataWriter {
    ...
    public ArffDataWriter(String fileName, PerformanceEventsHolder performanceEventsHolder, PerfDataHolder perfDataHolder) throws IOException {
